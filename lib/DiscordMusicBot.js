...
class DiscordMusicBot extends Client {
  ...
  /**
 * Checks if a message has been marked as deleted
 * @param {Message} message
 * @returns {boolean}
 */
isMessageDeleted(message) {
  // Thay vì kiểm tra trong deletedMessages, ta trực tiếp kiểm tra trạng thái của tin nhắn
  return message.isDeleted || false;
}

/**
 * Marks (pretends) a message as deleted
 * @param {Message} message
 */
markMessageAsDeleted(message) {
  // Thay vì thêm vào deletedMessages, ta đánh dấu trực tiếp trên tin nhắn
