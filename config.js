module.exports = {
	...
	clientId: process.env.clientId || "clientid", //- ID of the bot
	clientSecret: process.env.clientSecret || "clientSecret", //- Client Secret of the bot
	...
	nodes: [
		{
			...
			host: "lavalinksv", //- The host name or IP of the lavalink server.
